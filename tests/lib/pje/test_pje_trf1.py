...
class TestTrf1(unittest.TestCase):
    ...
    def test_trf1_get_detailed_data_for_cpf_37626361334(self):
        ...
        self.assertEqual('cpf', detailed_data.case_parties.active[0].documents[0].type)
        self.assertEqual('37626361334', detailed_data.case_parties.active[0].documents[0].value)
        ...
        self.assertEqual('oab', detailed_data.case_parties.active[1].documents[0].type)
        self.assertEqual('MA10539', detailed_data.case_parties.active[1].documents[0].value)
        ...
        self.assertEqual('cnpj', detailed_data.case_parties.passive[0].documents[0].type)
        self.assertEqual('29979036000221', detailed_data.case_parties.passive[0].documents[0].value)
        ...
        self.assertIsNone(detailed_data.movements[0].document_ref)
        self.assertIsNone(detailed_data.movements[0].document_date)
        ...
        self.assertIsNone(detailed_data.movements[1].document_ref)
        self.assertIsNone(detailed_data.movements[1].document_date)
        ...
        self.assertIsNone(detailed_data.movements[2].document_ref)
        self.assertIsNone(detailed_data.movements[2].document_date)
        ...
        self.assertEqual('Sentença Tipo C (Sentença Tipo C)', detailed_data.movements[3].document_ref)
        self.assertEqual(datetime.datetime(2025, 7, 30, 16, 45, 20), detailed_data.movements[3].document_date)
        ...
        self.assertEqual('Sentença Tipo C (Sentença Tipo C)', detailed_data.movements[4].document_ref)
        self.assertEqual(datetime.datetime(2025, 7, 30, 16, 45, 20), detailed_data.movements[4].document_date)
        ...
        self.assertIsNone(detailed_data.movements[5].document_ref)
        self.assertIsNone(detailed_data.movements[5].document_date)
        ...
        self.assertIsNone(detailed_data.movements[6].document_ref)
        self.assertIsNone(detailed_data.movements[6].document_date)
        ...
        self.assertEqual('Sentença Tipo C (Sentença Tipo C)', detailed_data.movements[7].document_ref)
        self.assertEqual(datetime.datetime(2025, 7, 30, 16, 45, 20), detailed_data.movements[7].document_date)
        ...
        self.assertIsNone(detailed_data.movements[8].document_ref)
        self.assertIsNone(detailed_data.movements[8].document_date)
        ...
        self.assertEqual('Sentença Tipo C (Sentença Tipo C)', detailed_data.movements[9].document_ref)
        self.assertEqual(datetime.datetime(2025, 7, 30, 16, 45, 20), detailed_data.movements[9].document_date)
        ...
        self.assertEqual('Sentença Tipo C (Sentença Tipo C)', detailed_data.movements[10].document_ref)
        self.assertEqual(datetime.datetime(2025, 7, 30, 16, 45, 20), detailed_data.movements[10].document_date)
        ...
        self.assertIsNone(detailed_data.movements[11].document_ref)
        self.assertIsNone(detailed_data.movements[11].document_date)
        ...
        self.assertIsNone(detailed_data.movements[12].document_ref)
        self.assertIsNone(detailed_data.movements[12].document_date)
        ...
        self.assertIsNone(detailed_data.movements[13].document_ref)
        self.assertIsNone(detailed_data.movements[13].document_date)
        ...
        self.assertEqual('Ato ordinatório (Ato ordinatório)', detailed_data.movements[14].document_ref)
        self.assertEqual(datetime.datetime(2024, 11, 6, 0, 48, 45), detailed_data.movements[14].document_date)
        ...
        self.assertEqual('Ato ordinatório (Ato ordinatório)', detailed_data.movements[15].document_ref)
        self.assertEqual(datetime.datetime(2024, 11, 6, 0, 48, 45), detailed_data.movements[15].document_date)
        ...
        self.assertIsNone(detailed_data.movements[16].document_ref)
        self.assertIsNone(detailed_data.movements[16].document_date)
        ...
        self.assertIsNone(detailed_data.movements[17].document_ref)
        self.assertIsNone(detailed_data.movements[17].document_date)
        ...
        self.assertIsNone(detailed_data.movements[18].document_ref)
        self.assertIsNone(detailed_data.movements[18].document_date)
        ...
        self.assertIsNone(detailed_data.movements[19].document_ref)
        self.assertIsNone(detailed_data.movements[19].document_date)
        ...
        self.assertIsNone(detailed_data.movements[20].document_ref)
        self.assertIsNone(detailed_data.movements[20].document_date)
        ...
        self.assertIsNone(detailed_data.movements[21].document_ref)
        self.assertIsNone(detailed_data.movements[21].document_date)
        ...
        self.assertIsNone(detailed_data.movements[22].document_ref)
        self.assertIsNone(detailed_data.movements[22].document_date)
        ...
        self.assertIsNone(detailed_data.movements[23].document_ref)
        self.assertIsNone(detailed_data.movements[23].document_date)
        ...
        self.assertIsNone(detailed_data.movements[24].document_ref)
        self.assertIsNone(detailed_data.movements[24].document_date)
        ...
        self.assertIsNone(detailed_data.movements[25].document_ref)
        self.assertIsNone(detailed_data.movements[25].document_date)
        ...
        self.assertIsNone(detailed_data.movements[26].document_ref)
        self.assertIsNone(detailed_data.movements[26].document_date)
        ...
        self.assertIsNone(detailed_data.movements[27].document_ref)
        self.assertIsNone(detailed_data.movements[27].document_date)
        ...
        self.assertIsNone(detailed_data.movements[28].document_ref)
        self.assertIsNone(detailed_data.movements[28].document_date)
        ...
        self.assertIsNone(detailed_data.movements[29].document_ref)
        self.assertIsNone(detailed_data.movements[29].document_date)
        ...
        self.assertIsNone(detailed_data.movements[30].document_ref)
        self.assertIsNone(detailed_data.movements[30].document_date)
        ...
        self.assertIsNone(detailed_data.movements[31].document_ref)
        self.assertIsNone(detailed_data.movements[31].document_date)
        ...
        self.assertIsNone(detailed_data.movements[32].document_ref)
        self.assertIsNone(detailed_data.movements[32].document_date)
        ...
        self.assertEqual('Despacho (Despacho)', detailed_data.movements[33].document_ref)
        self.assertEqual(datetime.datetime(2022, 7, 4, 10, 2, 54), detailed_data.movements[33].document_date)
        ...
        self.assertIsNone(detailed_data.movements[34].document_ref)
        self.assertIsNone(detailed_data.movements[34].document_date)
        ...
        self.assertIsNone(detailed_data.movements[35].document_ref)
        self.assertIsNone(detailed_data.movements[35].document_date)
        ...
        self.assertIsNone(detailed_data.movements[36].document_ref)
        self.assertIsNone(detailed_data.movements[36].document_date)
        ...
        self.assertIsNone(detailed_data.movements[37].document_ref)
        self.assertIsNone(detailed_data.movements[37].document_date)
        ...
        self.assertIsNone(detailed_data.movements[38].document_ref)
        self.assertIsNone(detailed_data.movements[38].document_date)
