...
from lib.pje.service import get_trf5_service
...
class TestTrf5(unittest.TestCase):
    ...
    def test_trf5_get_simple_data_for_cpf_03277868419(self):
    ...
    def test_trf5_get_detailed_data_for_cpf_06013333815(self):
        detailed_data = get_trf5_service(self.driver).get_detailed_process(
            term='032.778.684-19',
            grade='pje1g',
        )
