...
Revision ID: a2a3825e554e
Revises: a70057b5e5be
Create Date: 2025-10-10 21:45:02.401785
...
revision: str = 'a2a3825e554e'
down_revision: Union[str, Sequence[str], None] = 'a70057b5e5be'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_crawl_tasks_log_process_id'), 'crawl_tasks_log', ['process_id'], unique=False)
    ...
    sa.Column('protocol_b64', sa.Text(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_crawl_tasks_log_process_id'), table_name='crawl_tasks_log')
